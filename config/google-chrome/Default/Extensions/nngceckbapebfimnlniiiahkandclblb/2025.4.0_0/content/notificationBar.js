        ...
        function processMessages(msg, sendResponse) {
            ...
            if (msg.command === "openNotificationBar") {
                ...
                (_a = notificationBarIframe.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage({
                    ...
                    username: (_c = msg.data) === null || _c === void 0 ? void 0 : _c.username,
                    cipherId: (_d = msg.data) === null || _d === void 0 ? void 0 : _d.cipherId,
                }, "*");
            }
        }
        ...
        function openBar(type, barPage, notificationBarInitData) {
            return notification_bar_awaiter(this, void 0, void 0, function* () {
                ...
                function getIframeStyle(useComponentBar) {
                    const isNotificationFresh = notificationBarInitData.launchTimestamp &&
                    ...
                    const transitionStyle = isNotificationFresh && useComponentBar
